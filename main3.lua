...
Всё произошло за один миг. Всего лишь пол секунды -- и сложный, отлаженный механизм превратился в облако космического мусора...^^
		...
		Вращаясь, ты медленно плыл в пустоте...]];
...
local channels = {
	...
	{ "Ты поймал по радио передачу новостей." };
...
obj {
	...
	description = function(s)
		...
		if here().rotate then
			p [[Но сейчас ты думаешь только про маневровые двигатели.]]
			return
		end
		if not known then
			p [[Например, радио.]]
	...
	obj {
		...
		nam = 'engines';
		description = [[Маневровые двигатели позволяют ориентироваться в пространстве и перемещаться на небольшие расстояния.]];
...
door {
	...
	description = function() p [[Рядом с люком находится красный рычаг.]]; return false; end;
...
Им оказался спутник в форме тетраэдра.]];
	...
	obj {
		-"спутник,тетраэдр/но|объект|НЛО";
